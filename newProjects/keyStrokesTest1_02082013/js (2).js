...
var playerSprite = {
    x : 300, y : 300, width : 50, height : 80, xVel : 0, yVel : 0, ColorR : 40, ColorG : 100, ColorB : 255, ColorA : 1, Line : 1, SizeRate : 1, SizeSwitch : true, faceLeft : false, faceRight : false, gunPosX : 0, gunPosY : 0, gunMarkerSize : 30, gunMarkerCol : '#f00'
  };

  var enemySprite = {
    x : 300, y : floor, width : 50, height : 80, xVel : 5, yVel : 0, ColorR : 255, ColorG : 60, ColorB : 255, ColorA : 1, Line : 1, SizeRate : 1, health : 100
  };
...
function circle(x, y, r, c) {
    ...
    rad.addColorStop(0, 'rgba('+c+',0.1)');
    rad.addColorStop(0.5, 'rgba('+c+',0.02)');
